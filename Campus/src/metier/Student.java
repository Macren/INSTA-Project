...
public class Student extends AbstractUser implements IDocUse {
     ...
     * @param lessons 
     */
    public Student(String login, String passwd, String mail, String birthDate, String firstName, String lastName, int phone, int schoolID, int educationID, List<Lesson> lessons) {
